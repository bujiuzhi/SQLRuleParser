...
BEGIN
    ...
    /*====================================================================================================
            ...
            ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00272'   AS gzdm        -- 规则代码 , t1.sjrq     AS sjrq        -- 数据日期 , t1.cpdm     AS cpdm        -- 产品代码 , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行 , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    FROM report_cisp.wdb_amp_inv_bond t1
    WHERE t1.jgdm = '70610000'
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00273'   AS gzdm        -- 规则代码 , t1.sjrq     AS sjrq        -- 数据日期 , t1.cpdm     AS cpdm        -- 产品代码 , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行 , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    FROM report_cisp.wdb_amp_inv_bond t1
             LEFT JOIN report_cisp.wdb_amp_inv_bond t2
                       ON t1.jgdm = t2.jgdm
                           AND t1.status = t2.status
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00274'   AS gzdm        -- 规则代码 , t1.sjrq     AS sjrq        -- 数据日期 , t1.cpdm     AS cpdm        -- 产品代码 , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行 , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    FROM report_cisp.wdb_amp_inv_bond t1
    WHERE t1.jgdm = '70610000'
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00275'   AS gzdm        -- 规则代码 , t1.sjrq     AS sjrq        -- 数据日期 , t1.cpdm     AS cpdm        -- 产品代码 , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行 , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    FROM report_cisp.wdb_amp_inv_bond t1
             LEFT JOIN report_cisp.wdb_amp_prod_baseinfo t2
                       ON t1.jgdm = t2.jgdm
                           AND t1.status = t2.status
