...
BEGIN
    ...
    WHERE t1.jgdm = '70610000'
        ...
        --    大集合: 219-股票型QDII、229-混合型QDII、239-债券型QDII、258-FOF型QDII、259-MOM型QDII、298-其他QDII
        AND t1.cplb NOT IN ('119', '129', '139', '158', '159', '198', '219', '229', '239', '258', '259', '298')
        AND t1.jwtzgwzwmc IS NOT NULL
       OR t1.jwtzgwywmc IS NOT NULL
    ...
    WHERE t1.jgdm = 70610000
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
      AND substr(t1.jydsfcpdm, 7, 1) = '1'
      -- 交易对手方类型: 201-银行理财产品、202-银行子公司公募理财、203-银行子公司理财产品
      AND t1.jydsflx NOT IN ('201', '202', '203')
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"2"的，{交易对手方类型}应为“信托公司资管产品";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"3"的，{交易对手方类型}应为“证券公司及其子公司资管产品";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"4"的，{交易对手方类型}应为“基金管理公司及其子公司专户";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    WHERE t1.jgdm = 70610000
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
      AND substr(t1.jydsfcpdm, 7, 1) = '4'
      -- 交易对手方类型: 212-基金管理公司公募基金、214-基金管理公司子公司资产管理计划
      AND t1.jydsflx NOT IN ('212', '214')
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"5"的，{交易对手方类型}应为“期货公司及其子公司资管产品";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    WHERE t1.jgdm = 70610000
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
      AND substr(t1.jydsfcpdm, 7, 1) = '5'
      -- 交易对手方类型: 215-期货公司资产管理计划、216-期货公司子公司资产管理计划
      AND t1.jydsflx NOT IN ('215', '216')
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"6"的，{交易对手方类型}应为“保险资管产品";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    WHERE t1.jgdm = 70610000
      AND t1.status NOT IN ('3', '5')
      AND t1.sjrq = v_pi_end_date_t2 --若测试，请注释本行
      AND substr(t1.jydsfcpdm, 7, 1) = '6'
      -- 交易对手方类型: 205-保险产品、206-保险公司资产管理计划、229-保险公司子公司公募基金、207-保险公司子公司资产管理计划
      AND t1.jydsflx NOT IN ('205', '206', '229', '207')
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {交易对手方产品代码}第7位为"8"的，{交易对手方类型}应为“公募基金";
    # 规则来源: 人行
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00027'   AS gzdm        -- 规则代码 , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    # 目标接口传输频度: 月
    # 目标接口传输时间: T+7日24:00前
    # 规则说明: {项目编号}为｛2000-营业总支出、2001-管理人报酬、200101-其中：暂估管理人报酬、2002-托管费、2003-销售服务费、2004-投资顾问费、2005-利息支出、200501-卖出回购金融资产利息支出、2006-信用减值损失、2007-税金及附加、2099-其他费用｝时，本月金额不能为负数
    # 规则来源: AMTEC
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+4日24:00前
    # 规则说明: {期末账户数}={截至期末从未有交易的户数}+{截至期末曾经有交易的户数}
    # 规则来源: AMTEC
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    # 目标接口传输频度: 日
    # 目标接口传输时间: T+2日24:00前
    # 规则说明: 场内交易第17-23项应该填写0，17{手续费}、18{手续费（归管理人）}、19{手续费（归销售机构）}、20{手续费（归产品资产）}、21{后收费}、22{后收费（归管理人）}、23{后收费（归销售机构）}
    # 规则来源: AMTEC
    # 风险等级: 0
    # 其他接口数量: 0
    # 其他接口:
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00502'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00503'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00504'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00505'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00506'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00507'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00508'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00509'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00510'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00511'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00512'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00513'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00514'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00515'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00516'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00517'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00518'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00519'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00520'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00521'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00522'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00523'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    UNION ALL
    SELECT DISTINCT 'AM00524'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    /*UNION ALL
    SELECT DISTINCT 'AM00525'   AS gzdm        -- 规则代码
                  , t1.sjrq     AS sjrq        -- 数据日期
                  , t1.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
    ...
    ====================================================================================================*/
    /*UNION ALL
    SELECT DISTINCT 'AM00526'   AS gzdm        -- 规则代码
                  , t2.sjrq     AS sjrq        -- 数据日期
                  , t2.cpdm     AS cpdm        -- 产品代码
                  , pi_end_date AS insert_time -- 插入时间，若测试，请注释本行
                  , 0           AS fxdj        -- 风险等级 0-严重 1-警告
